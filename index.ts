...
// let userInf1: () => void;
// let userInf2: (name: string) => string;
...
//! interface
// same structurer jonno interface use hoy and
// custom type er jonno 'type' use hoy
// type RequestType = "GET" | "POST"; // custom Type


//! genric
// Es6 not allowed 
//Jkhn data ki typer hobe ta sure na thake, orthat vibinno rokom hote pare 
// any type cheacking disable kore but genric checking kore 

function printUserInf<T>(data: T):T{
    return data
}

printUserInf(12)
printUserInf("mr. potato")